...
<head>
    ...
    <link rel="stylesheet" href="assets/css/owl.theme.default.min.css" rel="stylesheet" type="text/css">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="navbar-buttons">
                    <a href="void:;" class="call-btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">Let's Get Started</a>
                    <a href="void:;" class="live-cht" onclick="setButtonURL();">live Chat</a>
                </div>
            </nav>
        </div>
    </header>