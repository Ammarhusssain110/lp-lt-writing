...
<main>
    ...
    <section class="new-ser-banner">
        <div class="container">
            <div class="row ">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xx-6" data-aos="fade-left">
                    <div class="banner-content">
                        <h1 class="banner-heading">If You Like Discounts, You're About to Love This!</h1>
                        <p class="banner-para">We know you have been waiting for this the whole year and we are about to make it worth your while. For this coming Black Friday, we decided to go all out on our prices so that you can go all out on your book!</p>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xx-6">
                    <div class="ban-right-form">
                        <form action="https://leads.infinityprojectmanager.com/brand/lt-writing/lead" method="GET">
                            ...
                            <input type="hidden" id="lead_area" name="lead_area"
                                value="https://lt-writing.com/lp/black-friday">
                            <div class="form-wrap shadow-lg">
                                <h3 class="heading">Take Control Of
                                    Your Writing Journey<span>!</span></h3>
                                <div class="">
                                    <div class="mb-3">
                    ...
                    <div class="bandown-brands-inner">
                        <div class="bandown-brands-item">
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-1.webp" alt="brand" class="img-fluid">
                            </div>
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-2.webp" alt="brand" class="img-fluid">
                            </div>
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-3.webp" alt="brand" class="img-fluid">
                            </div>
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-4.webp" alt="brand" class="img-fluid">
                            </div>
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-5.webp" alt="brand" class="img-fluid">
                            </div>
                            <div class="brands-item-img">
                                <img src="assets/images/brand-logo/bl-6.webp" alt="brand" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-evenly align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    <div class="story-details">
                        <h4>Premium Writing at Unbelievable Prices!</h4>
                        <p>We love giving our clients what they want. And we know exactly what you want on this incoming Black Friday. Brace yourself for the best deals, discounts, offers, and packages on book writing, publishing, marketing, and editing services. Everything you need to make sure your author's journey takes off!</p>
                        <button class="start-btn" data-bs-toggle="modal" data-bs-target="#exampleModal1">Let's Get
                            Started</button>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5">
                    <div class="story-book">
                        <img src="assets/images/story-book.webp" alt="img" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-evenly align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                    <div class="services-title">
                        <h4>Our Services</h4>
                        <p>We provide everything an author needs to ensure their idea can become a book and prove to be a successful endeavor at the end of the journey. </p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card services-card">
                        <div class="services-inner">
                            <div class="services-details-img">
                                <img src="assets/images/icon/scroll.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h5>Book Writing</h5>
                                <p>Share your epic idea with us and watch how our in-house book wizards turn it into a potential best-seller.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card services-card">
                        <div class="services-inner">
                            <div class="services-details-img">
                                <img src="assets/images/icon/text.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h5>Book Editing</h5>
                                <p>In case you have a manuscript, our editing professionals can convert it into a polished masterpiece. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card services-card">
                        <div class="services-inner">
                            <div class="services-details-img">
                                <img src="assets/images/icon/vector.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h5>Book Publishing</h5>
                                <p>Done with all the book writing hard work? Let's make sure your book reaches all the right places for your readers to find. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card services-card">
                        <div class="services-inner">
                            <div class="services-details-img">
                                <img src="assets/images/icon/reading.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h5>Book Marketing</h5>
                                <p>Is your published work not performing well? Well, our marketing experts can bump up those numbers!</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- sec-services-inner  start here -->
    <section class="sec-services-inner">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="services-inner-box">
                        <div class="services-box">
                            <div class="services-img">
                                <img src="assets/images/icon/anniversary.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h4><span id="number1">10</span>+ Years Of <br>
                                    Experience</h4>
                            </div>
                        </div>
                        <div class="services-box">
                            <div class="services-img">
                                <img src="assets/images/icon/author.png" alt="img" class="img-fluid">
                            </div>
                            <div class="services-details">
                                <h4><span id="number2">250</span>+ American <br>
                                    Writers</h4>
                            </div>
                        </div>
                        <div class="services-box">
                            ...
                            <div class="services-details">
                                <h4><span id="number3">700</span>+ Books <br>
                                    Written</h4>
                            </div>
                        </div>
                    </div>
    ...
    <!-- sec-services-inner  end here -->
    <!-- sec-cta start here -->
    <section class="sec-cta">
        <div class="container">
            <div
                class="row  justify-content-evenly align-items-center flex-column-reverse flex-md-row flex-lg-row  flex-xl-row flex-xxl-row">
                <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 col-xxl-7">
                    <div class="cta-details">
                        <h2>Black Friday is Here & So Are Our Crazy Deals!</h2>
                        <p>We are on a mission to give a new definition to affordable book-writing services this year!</p>
                        <button class="btn live-btn" onClick="<?php echo $locChatClick ;?>">live chat</button>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                    <div class="cta-img">
                        <img src="assets/images/cta-sale.png" alt="img" class="imf-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="portfolio-title">
                        ...
                        <p>No need to convince a client yourself when your work does it for you!</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="portfolio-tab-inner">
                        ...
                        <div class="row">
                            ...
                            <div class="fade tab-pane active show" id="nav-fiction" role="tabpanel"
                                ...
                                <div class="fade tab-pane" id="nav-triller" role="tabpanel" aria-labelledby="nav-triller-tab">
                                    <div class="pt-portfolio-wrap">
                                        <div class="pt-new-img">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                    <div class="process-title">
                        ...
                        <p>If you were wondering how our book writers get the job done, you are about to find out. </p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="card process-card">
                        <div class="process-inner">
                            <div class="process-details">
                                <h6>step 01</h6>
                                <h5>Detailed Discussion</h5>
                            </div>
                        </div>
                        <p>Our professionals start by discussing and understanding your book idea and vision.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card process-card">
                        ...
                        <p>Now that we know what's in your mind, we can start working on the rough draft of your book.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card process-card">
                        <div class="process-inner">
                            <div class="process-details">
                                <h6>step 03.</h6>
                                <h5>Feedback & Revisions</h5>
                            </div>
                        </div>
                        <p>With a chapter or two in hand, we ask for your feedback so that we can set the correct tone and style.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-3">
                    <div class="card process-card">
                        ...
                        <p>Once your book is completed, we again ask for your feedback and implement any revisions if necessary.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="customer-feedback-wrap">
        <div class="container">
            <div
                class="row justify-content-center align-items-center flex-column-reverse  flex-lg-row  flex-xl-row flex-xxl-row ">
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5">
                    <div class="customer-feedbcack-images">
                        <img src="assets/images/client.png" alt="img" class="img-fluid">
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 col-xxl-5">
                        ...
                        <div class="feedback-content-slider">
                            <div class="feedback-slider-item">
                                ...
                                <div class="feedback-inner">
                                    <p>“LT Writing's team made my dream of becoming an author a reality. Their editing finesse and savvy marketing strategies were exceptional.”</p>
                                </div>
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <div class="feedback-inner">
                                    <p>“From writing to publishing, LT Writing was with me every step. Their guidance made the process smooth, and their marketing expertise was invaluable.”</p>
                                </div>
                                <div class="feedback-info">
                                    <p>Derek George</p>
                                </div>
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <div class="feedback-inner">
                                    <p>“Professional, attentive, and highly skilled - LT Writing turned my manuscript into a masterpiece. Their marketing approach significantly increased my book's reach.”</p>
                                </div>
                                <div class="feedback-info">
                                    <p>Casey Bruce</p>
                                </div>
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <div class="feedback-inner">
                                    <p>“Choosing LT Writing was the best decision for my book. Their editing and marketing skills are top-notch, making the publishing process effortless.”</p>
                                </div>
                                <div class="feedback-info">
                                    <p>Alex Sinclair</p>
                                </div>
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <div class="feedback-inner">
                                    <p>“LT Writing’s expertise in book writing and marketing is unmatched. They transformed my ideas into a compelling book, attracting a wide audience.”</p>
                                </div>
                                <div class="feedback-info">
                                    <p>Natalie Chris</p>
                                </div>
    ...
    <section class="sec-contact-form">
        <div class="container">
            <div
                class="row justify-content-evenly align-items-center flex-column-reverse  flex-lg-row  flex-xl-row flex-xxl-row">
                <div class="col-xx-5 col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                ...
                <div class="col-xx-5 col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                    <div class="contact-details">
                        ...
                        <p>The time for thinking is over. Now's the time to pick up the phone and confirm your order!</p>
                        <form action="https://leads.infinityprojectmanager.com/brand/lt-writing/lead" method="GET">
                            <input type="hidden" name="brand_name" value="lt-writing.com">
                            <input type="hidden" id="lead_area" name="lead_area"
                                value="https://lt-writing.com/lp/black-friday">
